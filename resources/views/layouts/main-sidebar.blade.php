				...
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						...
						<div class="user-info">
							...
							<span class="mb-0 text-muted">    البريد الالكتروني</span>
						</div>
					</div>
				</div>
				<ul class="side-menu" >
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}"> عرض الفواتير </a></li>
                            ...
                            <li><a class="slide-item" href="{{ url('/' . $page='chart-flot') }}">الفواتير المدفوعة جزئيا </a></li>
